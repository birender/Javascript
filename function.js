...
console.log( {"Original:":arr,"Map:":output,"Filter:":output1,"Reduce:":output2,"Sum:":sumarr(),"findArr:":findArr} );

var users = [{'firstname':'Birender','lastname':'Rana','age':38},{'firstname':'Sahil','Taneja':'Rana','age':31},{'firstname':'Abhishek','lastname':'Sharma','age':30}];
...
console.log( {"Users:":users,"FilterAge:": FilterAge, "combineMap:":combineMap,"userreduce":userreduce,"findValue:":findValue} );
